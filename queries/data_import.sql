...
-- Right-click and choose 'Format Cells', Under the 'Number' tab, select 'Custom'.
-- Type in the format yyyy-mm-dd hh:mm:ss and click OK, Excel will now display the dates in desired format.
